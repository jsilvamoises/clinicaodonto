 ...
 * TabelaMensal.java
 *
 * Created on 12/11/2010, 10:28:35
 */
 ...
 * @author Tiago
 */
public class TabelaMensal extends javax.swing.JPanel implements KeyListener{
    private JTabbedPane tabbed;
    private JScrollPane scroll;
    private SistemaFacade fachada = SistemaFacade.getInstance();

    /** Creates new form TabelaDiaria */
    public TabelaMensal(JTabbedPane tabbed, JScrollPane scroll) {
        this.tabbed = tabbed;
        this.scroll = scroll;
        initComponents();
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        try {
            ...
            TableModel tablelaEntrada = jTable1.getModel();
            TableModel tablelaSaida = jTable2.getModel();
    ...
    private void botaoGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoGravarActionPerformed
        ...
        try {
            fachada.gravaTabelaMensal(tab1, tab2);
        } catch (Exception ex) {
           JOptionPane.showMessageDialog(null, ex.getMessage(),
