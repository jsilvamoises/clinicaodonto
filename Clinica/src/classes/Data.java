...
public class Data {
	...
	/**
	 * Metodo que recupera o n̼mero do m̻s para esta data de 0 a 11
	 * 
	 * @return O n̼mero do m̻s para esta data
	 */
	public int getMes() {
            if(data != null)
	...
	/**
	 * M̩todo que recupera o ano desta Data
	 * 
	...
	/**
	 * Verifica se as datas ṣo iguais ou depois da passada pelo parametro.
	 * @param data
	 * @return
	 */
	...
	/**
	 * Verifica se as datas ṣo iguais ou antes da passada pelo parametro.
	 * @param data
	 * @return
	 */
